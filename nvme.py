#
#  Copyright (C) 2021-2023 GENG YUN Technology Pte. Ltd.
#  All rights reserved.
#
...
class Buffer:
    def __init__() -> Buffer:
        """ Buffer(length, name=u'buffer', pvalue=0, ptype=0, offset=0, Controller nvme=None, fake_phys_addr=None, align=4096)
...
```
    ...
    def data(self, byte_end, byte_begin=None, type=int, endian=u'little') -> int | str:
    ...
    @property
    def name(self):
        """ Buffer.name: str =>  the name of the buffer  """
        pass
    ...
    def set_copy_range(self, index, int lba: int, int lba_count: int, format=0, storage_reference_tag=0, app_tag=0, app_tag_mask=0):
    ...
    def set_dsm_range(self, index, int lba: int, int lba_count: int, attr=0):
    ...
    @property
    def sgl(self):
        """ Buffer.sgl: bool =>  the flag of using SGL to present the memory buffer  """
        pass

    @property
    def size(self):
        """ Buffer.size: int =>  the size of the buffer presented in PRP/SGL  """
        pass
...
class Pcie:
    def __init__() -> Pcie:
        """ Pcie(unicode addr: str, vf=0, port=0, logdir=u'results', msi_only=False)
 Pcie class to access PCIe configuration and memory space. Prefer to use fixture "pcie" in test scripts.
    ...
    @property
    def addr(self):
        """ Pcie.addr: str =>  retrieve BDF address of the PCIe device """
        pass

    @property
    def aspm(self):
        """ Pcie.aspm: int =>  get the current ASPM config """
        pass

    @property
    def bme(self):
        """ Pcie.bme: bool =>  get the current BME state  """
        pass

    def cap_offset(self, int cap_id: int, extend=False) -> int:
        ...
        Args:
            ...
            extend (bool): access the extend capalibities
    ...
    def power_state(self):
        """ Pcie.power_state: int =>  get the current device power state """
        pass
    ...
    @property
    def speed(self):
        """ Pcie.speed: int =>  get the current link speed  """
        pass
...
```
    ...
    @property
    def addr(self):
        """ Controller.addr: str =>  BDF address of this NVMe device  """
        pass
    ...
    @property
    def cap(self):
        """ Controller.cap: int =>  get 64-bit CAP register of NVMe controller  """
        pass
    ...
    def cmdname(self, int opcode: int) -> str:
    ...
    def get_lba_format(self, data_size=512, meta_size=0, nsid=1) -> int:
    ...
    def getfeatures(self, fid, sel=0, buf=None, nsid=0xffffffff, cdw11=0, cdw12=0, cdw13=0, cdw14=0, cdw15=0, cb=None) -> Controller:
    ...
    @property
    def latest_cid(self):
        """ Controller.latest_cid: int =>  cid of latest completed command  """
        pass

    @property
    def latest_latency(self):
        """ Controller.latest_latency: int =>  latency of latest completed command in us  """
        pass
    ...
    @property
    def mdts(self):
        """ Controller.mdts: int =>  get max data transfer size MDTS in byte, limited to 2MB by driver  """
        pass

    def mi_receive(self, opcode, dword0=0, dword1=0, buf=None, mtype=1, cb=None) -> Controller:
    ...
    def mi_send(self, opcode, dword0=0, dword1=0, buf=None, mtype=1, cb=None) -> Controller:
    ...
    def nvme_init_func(self):
        """ Controller.nvme_init_func: callable =>  get current nvme init function  """
        pass
    ...
    def setfeatures(self, fid, sv=0, buf=None, nsid=0xffffffff, cdw11=0, cdw12=0, cdw13=0, cdw14=0, cdw15=0, cb=None) -> Controller:
    ...
    def supports(self, int opcode: int) -> bool:
    ...
    @property
    def timeout(self):
        """ Controller.timeout: int =>  current timeout value in milli-second.  """
        pass
...
class Qpair:
 ...
 Qpair class. IO SQ and CQ are combinded into the qpair. Prefer to use fixture "qpair" in test scripts.
    ...
    @property
    def depth(self):
        """ Qpair.depth: int =>  queue depth of the qpair  """
        pass
    ...
    @property
    def latest_cid(self):
        """ Qpair.latest_cid: int =>  cid of latest completed command in the qpair  """
        pass

    @property
    def latest_latency(self):
        """ Qpair.latest_latency: int =>  latency in micro-second of the latest completed command in the qpair  """
        pass
    ...
    @property
    def prio(self):
        """ Qpair.prio: int =>  queue priority of the qpair  """
        pass

    @property
    def sqid(self):
        """ Qpair.sqid: int =>  submission queue id in this qpair  """
        pass
...
class Namespace:
 ...
 Namespace class. Prefer to use fixture "nvme0n1" in test scripts.
    ...
    @property
    def capacity(self):
        """ Namespace.capacity: int =>  namespace capacity in byte  """
        pass
    ...
    def format(self, data_size=None, meta_size=0, ses=0, pil=0, pi=0, mset=0) -> int:
    ...
    def get_lba_format(self, data_size=512, meta_size=0) -> int:
        """ find the lba format by its data size and meta data size
    ...
    def get_sector_size(self, extended=False) -> int:
    ...
    def ioworker(self, qpair=None, io_size=8, lba_step=None, lba_align=None, lba_random=True, read_percentage=100, op_percentage=None, sgl_percentage=0, time=0, qdepth=63, region_start=0, region_end=0xffffffffffffffff, iops=0, io_count=0, io_flags=0, lba_start=0, qprio=0, distribution=None, ptype=0xbeef, pvalue=100, cdw13=0, io_sequence=None, slow_latency=1000000, fw_debug=False, exit_on_error=True, retry_max=0, verify_disable=False, zns=False, zns_zigzag=False, zns_syncwrite=False, cmdlog_error_only=False, output_io_per_second=None, output_percentile_latency=None, output_percentile_latency_opcode=None, output_cmdlog_list=None):
        ...
        Args:
            ...
            retry_max (int): max times of read retry when data mismatch found. Default: 10.
    ...
    @property
    def nsid(self):
        """ Namespace.nsid: int =>  id of the namespace  """
        pass
    ...
    def sector_size(self):
        """ Namespace.sector_size: int =>  current lba data size of the namespace  """
        pass
    ...
    def set_timeout_ms(self, opcode, msec):
        """ set timeout value of the command
 ...
 Subsystem class. Prefer to use fixture "subsystem" in test scripts.
    ...
    def poweron(self, quick=False):
        ...
        Args:
            ...
            quick (bool): consider more speed than compatibility. Default: False.
    ...
    def shutdown_notify(self, abrupt=False, timeout=_cTIMEOUT - 1):
...
class IOCQ:
    ...
    def wait_pbit(self, index, expected, timeout=10.0):
